...
PlaybackAssistant.prototype.setup = function() {
	...
	remoteCommandMenuModel.items[1].toggleCmd = 'go-playback';  //fix this
...
PlaybackAssistant.prototype.activate = function(event) {
...
PlaybackAssistant.prototype.deactivate = function(event) {
	/* remove any event handlers you added in activate and do any other cleanup that should happen before
	   this scene is popped or another scene is pushed on top */
};

PlaybackAssistant.prototype.cleanup = function(event) {
...
PlaybackAssistant.prototype.sendCommand = function(element, event) {
...
// Send commands to telnet connection
PlaybackAssistant.prototype.handleKey = function(event) {

	Mojo.Log.info("PlaybackAssistant.prototype.handleKey %o", event.originalEvent.keyCode);
...
PlaybackAssistant.prototype.sceneGoHeaderButton = function(event){
